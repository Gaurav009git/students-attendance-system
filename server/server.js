...
// Middleware - IMPORTANT: These must be uncommented!
app.use(cors({
    origin: '*',
    credentials: true
}));
app.use(express.json());  // ✅ UNCOMMENTED - This parses JSON bodies
app.use(express.urlencoded({ extended: true }));  // ✅ UNCOMMENTED - This parses URL-encoded bodies
